...
// Minor modification of https://github.com/lguilhermee/Discord-DX11-Overlay-Hook/blob/master/Helper/Helper.cpp 

uintptr_t PatternScan(const char* signature)
{
	uintptr_t moduleAddress = (uintptr_t)GetModuleHandleA(NULL);
